		...
		<div class="form-group">
			...
			<br>
			   ...
			   <input type="text"
                ...
                <table class="table" border="0px" id="dynamic_field">
                    <tr>
                        <td>
							<input 	type="text"
									name="objectives[]"
									placeholder="What is/are your objective/s?"
   ...
   <fieldset>
	...
	<script>
		$(document).ready(function(){
			...
			$('#add').click(function(){
			i++;
			$('#dynamic_field').append('<tr id="row'+i+'" class="dynamic-added"><td><input type="text" name="name[]" placeholder="Enter Objectives" class="form-control name_list" required /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');
			});
